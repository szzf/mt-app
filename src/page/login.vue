        ...
        <div class="login-panel">
            ...
            <div class="form">
                ...
                <div class="oauth-wrapper">
                    ...
                    <div class="oauth cf">
                        <a class="oauth__link oauth__link--qq" href="/account/connect/tencent" data-mtevent="{&quot;la&quot;:&quot;oauth/qq&quot;}"
                            target="_blank"></a>
                        <a class="oauth__link oauth__link--weibo" href="/account/connect/sina" data-mtevent="{&quot;la&quot;:&quot;oauth/sina&quot;}"
                            target="_blank"></a>
                    </div>
                </div>
            </div>
    ...
    methods: {
        submit() {
            ...
            api.login({
                ...
                this.error = 'status code 400页面异常, 请联系管理员'
                console.log(err)
            })
        }
    }
